...
import "../../App.css";
import { getDieuKien, updateDieuKien } from "../../helpers/helper";

// import { Form } from "reactstrap";
import { Form } from "antd";
import { Editor } from "@tinymce/tinymce-react";

function DieuKienPage() {
  ...
  const handlePostHome = async (values) => {
    ...
    const rs = await updateDieuKien(values);
    if (rs?.status === 1) {
