  ...
  return (
    <React.Fragment>
      ...
      {(navData || []).map((item, key) => {
        console.log(item?.permission, user?.user?.roleOfUser?.name);
        let flag = false;
        if (!item.permission) {
          flag = true;
        } else {
          if (
            ...
            item?.permission?.includes(user?.user?.roleOfUser?.name)
          )
            flag = true;
        }
        return (
                        ...
                        {item.subItems &&
                          (item.subItems || []).map((subItem, key) => {
                            if (subItem.permission) {
                              let flag = false;
                              if (
                                (subItem.permission === "admin" &&
                                  user?.user?.roleOfUser?.name ===
                                    "superAdmin") ||
